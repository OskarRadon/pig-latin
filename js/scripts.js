var pigLatin = function(input) {
  if (input[0] === 'a' || input[0] === 'e' || input[0] === 'i' || input[0] === 'o' || input[0] === 'u') {
    ...
    return input.slice(1) + input[0] + ("ay"); //if first letter is a consonant and second letter is a vowel
  } else if (input[0] != 'a' || input[0] != 'e' || input[0] != 'i' || input[0] != 'o' || input[0] != 'u') {
    return input.slice(2) + input[0] + input[1] + ("ay"); //if first two letters are consonants
  };
};
